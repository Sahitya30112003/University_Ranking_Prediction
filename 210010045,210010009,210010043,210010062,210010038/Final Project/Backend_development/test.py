...
import numpy as np
import pandas as pd  # handling and manipulating tabular data (dataframes)
...
# Proceed with your existing visualization
fig = plt.figure(figsize=(10, 10))
ax = fig.add_subplot(111)
cax = ax.matshow(correlations, cmap='coolwarm')

# Set ticks and labels
ticks = np.arange(0, numeric_df.shape[1], 1)
ax.set_xticks(ticks)
ax.set_yticks(ticks)
...
# Create the heatmap on the numeric columns
...
# Loop through each numeric feature (excluding 'Overall' if it's the target)
