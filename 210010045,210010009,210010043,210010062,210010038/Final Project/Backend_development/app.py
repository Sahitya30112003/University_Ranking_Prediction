...
st.write('<span><h1 style="color:red"><center>UNIVERSITY RANKING ANALYSIS</center></h1></span>',unsafe_allow_html=True)
...
if st.button('Predict'):
        ...
        st.write('<h5 style="color:purple"><center>INFORMATION REGARDING ALL THE UNIVERSITIES LISTED IN THE SEARCH BAR</center></h5>',unsafe_allow_html=True)
